        ...
        <div className="about-page-content-1">
          ...
          <div className="about-page-content-1-desc">
            <span>
              ...
              rem, blanditiis cum labore eveniet reiciendis unde et mollitia
              eius. Dolores deleniti ab hic dolorum quasi nostrum ex provident
              quod cumque.
            </span>
          </div>
        </div>
          ...
          <div className="about-page-content-2-list">
            <div className="team-card">
              <div className="team-card-pic">
                <Image
                  src="/assets/images/contents/about/herry.JPG"
                  alt="team-pic"
                  width={200}
                  height={200}
                />
              </div>
              <div className="team-idenity">
                <svg
